          ...
          <div className="mx-6 py-10 text-center md:text-left">
            ...
            <div className=''>
              <div className=' hidden md:block w-32 h-32 rounded-full'>
                ...
                <p className="mb-4 text-black flex items-center justify-center md:justify-start">
                  <div className='flex items-start  h-full justify-center md:items-center'>
                  <svg
                ...
                <span className='text-xs md:text-lg'>
                  Jl. Siliwangi No 123, Cibadak, Cibadak, 
